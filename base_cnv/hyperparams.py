...
def hyperparams():
    ...
    hp['unfixed'] = False
    hp['snp_thresh']=1200
    hp['experiment'] = 'MSI MSS hist eq'
    #hp['root_dir']='MSI_MSS_project/hist_eq_model/'
    #hp['data_dir'] = 'data'
    hp['root_dir']='/tcmldrive/hadar/MSI_MSS_project/hist_eq_model/base_for_cnv/base_for_cnv1/'
